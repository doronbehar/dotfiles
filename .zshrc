...
source ${ZDOTDIR:-$HOME}/.zsh/zle/brotab-nixpkgs.zsh
...
zstyle ':fzf-tab:*' switch-group 'ctrl-d' 'ctrl-u'
zstyle ':fzf-tab:*' fzf-bindings-default "tab:toggle+down,enter:accept"
zstyle ':fzf-tab:complete:(j(u|s)f|systemctl-)*:*' fzf-preview 'env words="$words" ${ZDOTDIR:-$HOME}/.zsh/zle/fzf/previewers/systemctl'
# give a preview of commandline arguments when completing `kill`
zstyle ':completion:*:*:*:*:processes' command "ps -u $USER -o pid,user,comm -w -w"
zstyle ':fzf-tab:complete:(kill|ps):argument-rest' fzf-preview \
	'[[ $group == "Completing process ID" ]] && pstree -a $word'
zstyle ':fzf-tab:complete:(kill|ps):argument-rest' fzf-flags --preview-window=down:3:wrap
zstyle ':fzf-tab:complete:git*' fzf-preview 'env words="$words" word=${word%% } ${ZDOTDIR:-$HOME}/.zsh/zle/fzf/previewers/git'
...
bindkey -M viins "^N" brotab-nixpkgs
