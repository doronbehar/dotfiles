# Generated by Powerlevel10k configuration wizard on 2020-03-08 at 00:31 IST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: awesome-fontconfig, small icons, lean_8colors, 1 line, compact,
...
() {
  ...
  function prompt_emails() {
    ...
    if [[ -n $message ]]; then
      p10k segment -b magenta -t $message
    fi
  }
